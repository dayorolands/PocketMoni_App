...
public class CableTVApprovedActivity extends AppCompatActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cable_tv_approved_activity);
        ...
        closeBtn.setOnClickListener((view)->{
            CardInfo.StopTransaction(CableTVApprovedActivity.this);
        });
        SetParameters();
    ...
    View.OnClickListener printButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(CableTVApprovedActivity.this, "PRINTING RECEIPT", Toast.LENGTH_SHORT).show();
            if(i == 0) {   //PRINT CUSTOMER COPY
                i++;
                CableTVReceipt.setMerchantOrCustomerCopy("CUSTOMER COPY");
                CableTVReceipt.Print(CableTVApprovedActivity.this);
            }
