...
public class AirtimeReceipt {
    ...
    private static Bitmap printBitmap() {
        ...
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("NETWORK: ", model.getBillsCode(), 20, true, false));
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("PHONE NO: ", model.getCustomerId(), 20, true, false));
    ...
    private static Bitmap reprintBitmap(final String[] result) {
        ...
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("NETWORK: ", result[15], 20, true, false));
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("PHONE: ", result[14], 20, true, false));
