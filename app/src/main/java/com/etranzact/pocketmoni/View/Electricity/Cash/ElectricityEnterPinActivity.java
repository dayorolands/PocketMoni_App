...
public class ElectricityEnterPinActivity extends AppCompatActivity implements View.OnClickListener {

    TextView pinText, pinMessage, name, subscriptionPlan, amount, outstandingBal, meterNo;
    Button payButton;
    ImageView btnBack;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.electricity_enterpin_activity);
        ...
        meterNo.setText(model.getCustomerId());
    ...
    private void btnProceed(String pinValue)
    {
        ...
        model.setPin(encPin);
        startActivity(new Intent(this, ElectricityTransactionActivity.class));
        finish();
    }
}