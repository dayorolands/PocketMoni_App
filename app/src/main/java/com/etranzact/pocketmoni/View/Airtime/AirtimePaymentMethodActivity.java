...
import com.etranzact.pocketmoni.View.Airtime.Card.AirtimeCardEnterPinActivity;
import com.etranzact.pocketmoni.View.Airtime.Cash.AirtimeEnterPinActivity;
...
public class AirtimePaymentMethodActivity extends AppCompatActivity implements PosHandler, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.airtime_payment_method_activity);
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.debit_card_id){
            ...
            startActivity(new Intent(this, AirtimeEnterPinActivity.class));
            finish();
        }
    }
    ...
    public void onEnterPinRequested(Activity activity) {
        ...
        startActivity(new Intent(activity, AirtimeCardEnterPinActivity.class));
        finish();
    }
    ...
    public void onCardTimeount() {
        Toast.makeText(AirtimePaymentMethodActivity.this, "CARD READ TIMEOUT", Toast.LENGTH_LONG).show();
        Disconnect();
    }
