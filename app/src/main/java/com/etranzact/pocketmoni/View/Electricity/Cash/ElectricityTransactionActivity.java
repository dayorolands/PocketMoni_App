...
public class ElectricityTransactionActivity extends AppCompatActivity {
    ...
    void startTransaction() {
        Thread t = new Thread(()->{
            String response =  model.processDeposit(ElectricityTransactionActivity.this);
    ...
    Handler OnTransactionResponse = new Handler(Looper.getMainLooper(), (msg)->{
        ...
        if(response == null){
            Toast.makeText(ElectricityTransactionActivity.this, "TRANSACTION ROUTE NOT FOUND", Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        if(respCode.equals("")){
            Toast.makeText(ElectricityTransactionActivity.this,"No response from server, Try again", Toast.LENGTH_LONG).show();
            finish();
        } else if (respCode.equals("00")) {
            String description = Keys.parseJson(response, "responseMessage");
    ...
    private void ShowApproved() {
        ...
        startActivity(new Intent(this, ElectricityApprovedActivity.class));
        finish();
    }
    ...
    void ShowDeclined() {
        ...
        startActivity(new Intent(this, ElectricityFailedActivity.class));
        finish();
    }
