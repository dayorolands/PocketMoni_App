...
public class AirtimeFailedActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.airtime_failed_activity);
        ...
        closeBtn.setOnClickListener((view)->{
            CardInfo.StopTransaction(AirtimeFailedActivity.this);
        });
    ...
    View.OnClickListener printButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(AirtimeFailedActivity.this, "PRINTING RECEIPT", Toast.LENGTH_SHORT).show();
            if(i == 0) {   //PRINT CUSTOMER COPY
                i++;
                AirtimeReceipt.setMerchantOrCustomerCopy("CUSTOMER COPY");
                AirtimeReceipt.Print(AirtimeFailedActivity.this);
            }
