...
public class ElectricityApprovedActivity extends AppCompatActivity {

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.electricity_approved_activity);
        ...
        closeBtn.setOnClickListener((view)->{
            CardInfo.StopTransaction(ElectricityApprovedActivity.this);
        });
        SetParameters();
    ...
    View.OnClickListener printButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(ElectricityApprovedActivity.this, "PRINTING RECEIPT", Toast.LENGTH_SHORT).show();
            if(i == 0) {   //PRINT CUSTOMER COPY
                i++;
                ElectricityReceipt.setMerchantOrCustomerCopy("CUSTOMER COPY");
                ElectricityReceipt.Print(ElectricityApprovedActivity.this);
            }
