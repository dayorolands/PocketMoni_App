...
public class BillsFailedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeBtn.setOnClickListener((view)->{
            CardInfo.StopTransaction(BillsFailedActivity.this);
        });
    ...
    View.OnClickListener printButtonClicked = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(BillsFailedActivity.this, "PRINTING RECEIPT", Toast.LENGTH_SHORT).show();
            if(i == 0) {   //PRINT CUSTOMER COPY
                i++;
                DepositReceipt.setMerchantOrCustomerCopy("CUSTOMER COPY");
                DepositReceipt.Print(BillsFailedActivity.this);
            }
