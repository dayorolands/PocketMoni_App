...
public class CableTVReceipt {
    ...
    private static Bitmap printBitmap() {
        ...
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("BILLER: ", model.getBillsName(), 20, true, false));
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("REF: ", model.getPaymentRef(), 20, true, false));
        if(!model.getBillsName().toLowerCase().equals("startimes")){
            combBitmap.addBitmap(GenerateBitmap.str2Bitmap("PLAN: ", model.getProductName(), 20, true, false));
    ...
    private static Bitmap reprintBitmap(final String[] result) {
        ...
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("BILLER: ", result[15], 20, true, false));
        combBitmap.addBitmap(GenerateBitmap.str2Bitmap("REF: ", result[16], 20, true, false));
        if(!result[15].toLowerCase().equals("startimes")){
            combBitmap.addBitmap(GenerateBitmap.str2Bitmap("PLAN: ", result[18], 20, true, false));
