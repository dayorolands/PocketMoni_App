package com.etranzact.pocketmoni.View.Airtime.Card;
...
public class AirtimeCardEnterPinActivity extends AppCompatActivity implements View.OnClickListener, PosHandler {

    TextView pinText, pinMessage, name, subscriptionPlan, amount, fee, total;
    Button payButton;
    ImageView btnBack;
    AirtimeModel model;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.airtime_card_enterpin_activity);
        ...
        name.setText(model.getBillsName());
        subscriptionPlan.setText(model.getBillsName());
