...
public class CableTVEnterPinActivity extends AppCompatActivity implements View.OnClickListener {

    TextView pinText, pinMessage, name, subscriptionPlan, amount, meterNo;
    Button payButton;
    ImageView btnBack;
    CableTVModel model;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cable_tv_enterpin_activity);
    ...
    private void btnProceed(String pinValue)
    {
        ...
        model.setPin(encPin);
        startActivity(new Intent(this, CableTVTransactionActivity.class));
        finish();
    }
}